...
//  anything Room for Mac can't back up with a real result: a missing command-line tool, a machine
...
enum Capabilities {
    ...
    /// Whether Room for Mac may talk to an app through Apple Events. Nil until a call has been made;
