//  Text printer for the disk map, used by `clean disk`. The rest of the command line lives in CLI.swift.

import Foundation

/// `RoomMac --dump` prints the same map as plain text and exits. Handy for scripts and for checking the parser.
enum Dump {
    /// Prints the disk map as text. Used by `clean disk`.
